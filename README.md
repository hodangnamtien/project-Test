...
- [redux](https://redux.js.org/) để quản lý `state`.
- [redux-toolkit](https://redux-toolkit.js.org/) để.
- [async-storage](https://react-native-async-storage.github.io/async-storage/docs/install/) để lưu dữ liệu vào local
- [redux-persist](https://github.com/rt2zz/redux-persist) để xử lý logic những dữ liệu đã lưu vào local .
- [jest](https://facebook.github.io/jest/) and [react-native-testing-library](https://callstack.github.io/react-native-testing-library/) để kiểm thử.
